...
<section class="product_detail">
    ...
    <!-- 0923-image 수정 -->
        <div class="box1" style="background-image:url('${pvo.product_image1}')">
        </div>
        <button class="box2" onclick="detail1()" style="background-image:url('${pvo.product_image2}')">
        </button>
    ...
    <!-- 0923-image 수정 끝 -->
        ...
        <button type = "button" class="box13" id="genie">
            구매하기
        </button>
