...
<section class="genie_02">
	...
	<form class="grid-container4">
		<div class="tag_name">
			<input type="radio" name="birthday" id="8" value="8">
			<label for="8">생일</label>
		</div>
		<div class="tag_name">
			<input type="radio" name="anniversary" id="9" value="9">
			<label for="9">기념일</label>
		</div>
		<div class="tag_name">
			<input type="radio" name="hundred" id="10" value="10">
			<label for="10">백일</label>
		</div>
		<div class="tag_name">
			<input type="radio" name="house" id="11" value="11">
			<label for="11">집들이</label>
		</div>
		<div class="tag_name">
			<input type="radio" name="surprise" id="12" value="12">
			<label for="12">서프라이즈</label>
		</div>
		<div class="tag_name">
			<input type="radio" name="cheer" id="13" value="13">
			<label for="13">응원</label>
		</div>
		<div class="tag_name">
			<input type="radio" name="thanks" id="14" value="14">
			<label for="14">감사</label>
		</div>
		<div class="tag_name">
			<input type="radio" name="marriage" id="15" value="15">
			<label for="15">결혼</label>
		</div>
		<div class="tag_name">
			<input type="radio" name="birth" id="16" value="16">
			<label for="16">출산</label>
		</div>
		<div class="tag_name">
			<input type="radio" name="pregnancy" id="17" value="17">
			<label for="17">임신</label>
		</div>
		<div class="tag_name">
			<input type="radio" name="open" id="18" value="18">
			<label for="18">개업</label>
		</div>
		<div class="tag_name">
			<input type="radio" name="comfort" id="19" value="19">
...
<section class="genie_03">
	...
	<form class="grid-container3">
		<div class="tag_name">
			<input type="radio" name="man" id="20" value="20">
			<label for="20">10,000원 이하</label>
		</div>
		<div class="tag_name">
			<input type="radio" name="samman" id="21" value="21">
			<label for="21">10,000원~30,000원</label>
		</div>
		<div class="tag_name">
			<input type="radio" name="ohman" id="22" value="22">
			<label for="22">30,000원~50,000원</label>
		</div>
		<div class="tag_name">
			<input type="radio" name="sibman" id="23" value="23">
			<label for="23">50,000원~100,000원</label>
		</div>
		<div class="tag_name">
			<input type="radio" name="esibman" id="24" value="24">
			<label for="24">100,000원~200,000원</label>
		</div>
		<div class="tag_name">
			<input type="radio" name="expensive" id="25" value="25">
...
<section class="genie_04">
	...
	<form class="grid-container3">
		<div class="tag_name">
			<input type="radio" name="ten" id="26" value="26">
			<label for="26">0~10살</label>
		</div>
		<div class="tag_name">
			<input type="radio" name="twenty" id="27" value="27">
			<label for="27">10~20살</label>
		</div>
		<div class="tag_name">
			<input type="radio" name="thirty" id="28" value="28">
			<label for="28">20~30살</label>
		</div>
		<div class="tag_name">
			<input type="radio" name="forty" id="29" value="29">
			<label for="29">30~40살</label>
		</div>
		<div class="tag_name">
			<input type="radio" name="fifty" id="30" value="30">
			<label for="30">40~50살</label>
		</div>
		<div class="tag_name">
			<input type="radio" name="old" id="31" value="31">
...
<section class="genie_05">
	...
	<form class="grid-container3">
		<div class="tag_name">
			<input type="radio" name="men" id="32" value="32">
			<label for="32">남자</label>
		</div>
		<div class="tag_name">
			<input type="radio" name="women" id="33" value="33">
			<label for="33">여자</label>
		</div>
		<div class="tag_name">
			<input type="radio" name="all" id="34" value="34">
