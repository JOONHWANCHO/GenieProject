...
-->
  ...
  <!-- overlayScrollbars -->
  <link rel="stylesheet" href="/js_css/plugins/overlayScrollbars/css/OverlayScrollbars.min.css">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="/admin/adminMain" class="nav-link">Home</a>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
            ...
            <div class="card">
              ...
              <div class="card-body">
                <div class="row">
                  <div class="col-md-8">
                    <p class="text-center">
                      <strong>기간: 2022.09.01 - 2022.09.30</strong>
                    </p>
                  ...
                  <div class="col-md-4">
                    ...
                    <!-- /.progress-group -->
                    <div class="progress-group">
                      <span class="progress-text">방문객 수(MAU)</span>
                ...
                <div class="row">
                  <div class="col-sm-3 col-6">
                    <div class="description-block border-right">
                      ...
                      <h5 class="description-header">12,300,000원</h5>
                      <span class="description-text">총수익</span>
                    </div>
                    <!-- /.description-block -->
                  </div>
                  <!-- /.col -->
                  <div class="col-sm-3 col-6">
                    <div class="description-block border-right">
                      ...
                      <h5 class="description-header">3,200,000원</h5>
                      <span class="description-text">총비용</span>
                    </div>
                    <!-- /.description-block -->
                  </div>
                  <!-- /.col -->
                  <div class="col-sm-3 col-6">
                    <div class="description-block border-right">
                      ...
                      <h5 class="description-header">8,900,000원</h5>
                      <span class="description-text">총수익</span>
                    </div>
                    <!-- /.description-block -->
                  </div>
                  ...
                  <div class="col-sm-3 col-6">
                    <div class="description-block">
                      ...
                      <h5 class="description-header">3,200,000</h5>
                      <span class="description-text">영업이익</span>
                    </div>
                    <!-- /.description-block -->
                  </div>
                </div>
...
<!-- REQUIRED SCRIPTS -->
<!-- jQuery -->
<script src="/js_css/plugins/jquery/jquery.min.js"></script>
<!-- Bootstrap -->
<script src="/js_css/plugins/bootstrap/js/bootstrap.bundle.min.js"></script>
<!-- overlayScrollbars -->
<script src="/js_css/plugins/overlayScrollbars/js/jquery.overlayScrollbars.min.js"></script>
<!-- AdminLTE App -->
<script src="/js_css/dist/js/adminlte.js"></script>

<!-- PAGE PLUGINS -->
<!-- jQuery Mapael -->
<script src="/js_css/plugins/jquery-mousewheel/jquery.mousewheel.js"></script>
<script src="/js_css/plugins/raphael/raphael.min.js"></script>
<script src="/js_css/plugins/jquery-mapael/jquery.mapael.min.js"></script>
<script src="/js_css/plugins/jquery-mapael/maps/usa_states.min.js"></script>
<!-- ChartJS -->
<script src="/js_css/plugins/chart.js/Chart.min.js"></script>

<!-- AdminLTE for demo purposes -->
<script src="/js_css/dist/js/demo.js"></script>
<!-- AdminLTE dashboard demo (This is only for demo purposes) -->
<script src="/js_css/dist/js/pages/dashboard2.js"></script>
